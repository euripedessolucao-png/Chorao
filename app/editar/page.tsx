          ...
          <Card className="lg:col-span-2">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 flex-wrap">
                <Button variant="outline" onClick={() => navigator.clipboard.writeText(lyrics)} disabled={!lyrics}>
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-3">
              <Button onClick={handleImprove} disabled={isLoading || !lyrics.trim()} className="flex-1">
                {isLoading ? (
                  <>
            ...
            <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-blue-800 dark:text-blue-300">
                  <strong>Dica:</strong> O assistente mantém o estilo original enquanto aplica melhorias técnicas. Você
                  pode aplicar múltiplas melhorias em sequência.
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="mt-6">
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <Button variant="outline" className="flex flex-col h-auto py-3 bg-transparent">
