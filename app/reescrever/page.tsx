...
const GENRE_QUALITY_CONFIG = {
  Sertanejo: { min: 7, max: 10, ideal: 9, rhymeQuality: 0.5 },
  "Sertanejo Moderno": { min: 7, max: 10, ideal: 9, rhymeQuality: 0.5 },
  "Sertanejo Universitário": { min: 7, max: 10, ideal: 9, rhymeQuality: 0.5 },
  "Sertanejo Sofrência": { min: 7, max: 10, ideal: 9, rhymeQuality: 0.5 },
  "Sertanejo Raiz": { min: 7, max: 10, ideal: 9, rhymeQuality: 0.5 },
  "Sertanejo Moderno Feminino": { min: 7, max: 10, ideal: 9, rhymeQuality: 0.5 },
  "Sertanejo Moderno Masculino": { min: 7, max: 10, ideal: 9, rhymeQuality: 0.5 },
  MPB: { min: 8, max: 14, ideal: 11, rhymeQuality: 0.6 },
  "Bossa Nova": { min: 8, max: 14, ideal: 11, rhymeQuality: 0.6 },
  Funk: { min: 6, max: 10, ideal: 8, rhymeQuality: 0.3 },
  "Funk Carioca": { min: 6, max: 10, ideal: 8, rhymeQuality: 0.3 },
  "Funk Melody": { min: 6, max: 10, ideal: 8, rhymeQuality: 0.3 },
  "Funk Consciente": { min: 6, max: 10, ideal: 8, rhymeQuality: 0.3 },
  Piseiro: { min: 6, max: 10, ideal: 8, rhymeQuality: 0.3 },
  Pop: { min: 8, max: 10, ideal: 9, rhymeQuality: 0.4 },
  "Pop Brasileiro": { min: 8, max: 10, ideal: 9, rhymeQuality: 0.4 },
  Pagode: { min: 7, max: 10, ideal: 9, rhymeQuality: 0.4 },
  "Pagode Romântico": { min: 7, max: 10, ideal: 9, rhymeQuality: 0.4 },
  Samba: { min: 7, max: 10, ideal: 9, rhymeQuality: 0.4 },
  Forró: { min: 7, max: 10, ideal: 9, rhymeQuality: 0.4 },
  "Forró Pé de Serra": { min: 7, max: 10, ideal: 9, rhymeQuality: 0.4 },
  Axé: { min: 7, max: 10, ideal: 9, rhymeQuality: 0.3 },
  Rock: { min: 7, max: 10, ideal: 9, rhymeQuality: 0.4 },
  "Rock Brasileiro": { min: 7, max: 10, ideal: 9, rhymeQuality: 0.4 },
  Gospel: { min: 8, max: 10, ideal: 9, rhymeQuality: 0.5 },
  "Gospel Contemporâneo": { min: 8, max: 10, ideal: 9, rhymeQuality: 0.5 },
  Arrocha: { min: 7, max: 10, ideal: 9, rhymeQuality: 0.4 },
  Bachata: { min: 7, max: 10, ideal: 9, rhymeQuality: 0.4 },
  default: { min: 7, max: 10, ideal: 9, rhymeQuality: 0.4 },
}
