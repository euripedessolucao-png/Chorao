...
export default function CreatePage() {
  ...
  const genres = [
    'Sertanejo Moderno', 'Sertanejo', 'Sertanejo Universitário', 
    'Sertanejo Sofrência', 'Sertanejo Raiz', 'Pagode', 'Samba',
    'Forró', 'Axé', 'MPB', 'Bossa Nova', 'Rock', 'Pop', 'Funk', 'Gospel'
  ]
                      ...
                      {problematicLines && problematicLines.length > 0 && (
                        <button
                          onClick={() => {
                            ...
                            const fixed = generatedLyrics.split('\n').map(line => {
